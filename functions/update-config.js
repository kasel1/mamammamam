/**
 * Cloudflare Worker Multi-Sites - Version Template API Simplifiée
 * 
...
async function cloneSiteTemplate(data, env) {
  ...
  try {
    ...
    // Étape 4: Création du projet Cloudflare Pages
    console.log('☁️ Création du projet Cloudflare Pages...');
    const cloudflareResult = await createCloudflareProject(data.repo_name, REPO_OWNER, CLOUDFLARE_API_TOKEN, CLOUDFLARE_ACCOUNT_ID);
